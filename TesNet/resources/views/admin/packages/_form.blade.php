@php
    ...
    $startsAt = old('special_starts_at', isset($package?->special_starts_at) ? $package->special_starts_at->format('Y-m-d\TH:i') : '');
    $endsAt = old('special_ends_at', isset($package?->special_ends_at) ? $package->special_ends_at->format('Y-m-d\TH:i') : '');
@endphp
